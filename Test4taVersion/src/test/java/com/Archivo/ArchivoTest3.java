...
public class ArchivoTest3 {
	...
	By Aplicativo = By.xpath("//*[@id=\"form:singleDT_data\"]/tr/td");
	@Before
	...
	@Test
	public void Prue_0009() throws InterruptedException {
		if(driver.findElement(userLocator).isDisplayed()) {
			driver.findElement(userLocator).sendKeys("11111111111");
